                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="queryForm">
                                    ...
                                    <!-- Conditions -->
                                    <div class="mb-3">
                                        <label>{{ __('querybuilder::messages.form_query_conditions')}}:</label>
                                        <div id="conditions">
                                            <div class="condition-card mb-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control condition-value" name="conditions[0][value]" placeholder="{{ __('querybuilder::messages.form_query_value_placeholder') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-secondary btn-sm" id="addCondition">{{ __('querybuilder::messages.form_query_add_condition_button')}}</button>
                                        </div>
